...
set(gca,'FontSize',fontsize, 'LineWidth', axiswidth,'fontweight','bold',...
    'xlim',[min_t max_t],'ylim',[38 80],'FontName','Times New Roman');
%% DG Current
figure(2)
...
set(l,'FontSize',20,'FontName','Times New Roman');
set(gca,'FontSize',fontsize, 'LineWidth', axiswidth,'fontweight','bold',...
    'xlim',[min_t max_t],'ylim',[0 120], 'FontName','Times New Roman');
%% Line Current
figure(3)
i1=plot(out.i(:,1),out.i(:,2),'-');
hold on
...
set(l,'FontSize',20,'FontName','Times New Roman');
set(gca,'FontSize',fontsize, 'LineWidth', axiswidth,'fontweight','bold',...
    'xlim',[min_t max_t],'ylim',[-0.65 0.45],'FontName','Times New Roman');
...
set(l,'FontSize',20,'FontName','Times New Roman');
set(gca,'FontSize',fontsize, 'LineWidth', axiswidth,'fontweight','bold',...
    'xlim',[min_t max_t],'ylim',[0.5 2.5],'FontName','Times New Roman');
%% Average Voltage
figure(5)
...
set(x,'FontSize',fontsize,'FontName','Times New Roman');
set(gca,'FontSize',fontsize, 'LineWidth', axiswidth,'fontweight','bold',...
    'xlim',[min_t max_t],'ylim',[37 60],'FontName','Times New Roman','xticklabel',[]);
hold on
